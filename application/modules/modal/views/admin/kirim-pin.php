...
<div class="form-group">
    <button style="font-weight:bold" type="submit" id="btn01cc" class="btn btn-block btn-primary">KIRIM PIN KODE</button>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#form-kirimpin').submit(function(event) {
            ...
            $.ajax({
                    // kirimpinserial
                    url: '<?php echo site_url('postdata/admin_post/serial/cekkirimpin') ?>',
                    type: 'post',
                    dataType: 'json',
                    ...
                    if (data.status) {
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                $.ajax({
                                        url: '<?php echo site_url('postdata/admin_post/serial/kirimpinserial') ?>',
                                        type: 'post',
                                        dataType: 'json',
                                        data: $('#form-kirimpin').serialize(),
                                    })
