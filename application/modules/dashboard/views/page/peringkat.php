<?php
$this->template->title->set('Bonus Peringkat');
?>
<div class="alert alert-primary" role="alert" style="color:#000">
    Bonus Peringkat masuk dalam <strong>Kategori Profit Share</strong>, yang akan dibagikan setiap Tanggal 01, Penerima Bonus ini harus memenuhi Syarat Omset Pada Bulan Sebelumnya. <u><a href="javascript:" data-bs-toggle="modal" data-bs-target="#syarat" title="Lihat Syarat Bonus" style="color:#000">Lihat Syarat Bonus</a></u>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center class="mb-3 text-danger">Anda Wajib Memiliki 2 Kaki Sesuai Omset Berikut Ini</center>
                <div class="table-responsive table-bordered">
                    <table class="table">
                        <thead>
                            <tr>
                                <th style="vertical-align: middle;" class="text-center">Status</th>
                                <th style="vertical-align: middle;" class="text-center">Omset1 (BV)</th>
                                <th style="vertical-align: middle;" class="text-center">Omset2 (BV)</th>
                                <th style="vertical-align: middle;" class="text-center">Bonus</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Bonus Peringkat</h3>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            ...
            <?php echo $this->paginationmodel->paginate('peringkat', $Gettotal, $limit) ?>
        </div>
    </div>
</div>